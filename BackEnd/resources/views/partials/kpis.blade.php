...
<div id="seccion-6" style="display: none;">
    ...
    <div class="kpi-container">
        <div class="kpi-columna izquierda">
            ...
            <div class="kpi-item">
                ...
                <div class="kpi-opciones">
                    <label><input type="radio" name="preg_06_0{{ $loop->iteration }}" value="Cumple"> Cumple</label>
        ...
        <div class="kpi-columna derecha">
            ...
            <div class="kpi-item">
                ...
                <div class="kpi-opciones">
                    <label><input type="radio" name="preg_06_0{{ $loop->iteration + 3 }}" value="Cumple"> Cumple</label>
    ...
    <div class="observaciones">
        ...
        <div class="file_container">
            <input type="file" id="IMG_OBS_KPI_URL" name="IMG_OBS_KPI_URL" class="form-control-file" accept="image/png, image/jpeg">
        </div>
    </div>
