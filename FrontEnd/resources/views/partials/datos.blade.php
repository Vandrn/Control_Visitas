<div id="datos" class="solo-centro">
    <div class="form-group">
        ...
        <input type="email"
               id="correo_tienda_otro"
               name="correo_tienda"
               class="form-control mt-2"
               placeholder="Escribe el correo de la persona que realizó la visita"
               style="display:none;"
               pattern="^[a-zA-Z0-9._%+\-]+@empresasadoc.com$">
    </div>

    <div id="modalidad-group" class="modalidad-container">
        <label class="preguntas modalidad-label">Selecciona la modalidad:</label>

        <div class="modalidad-btn-group">
            <button type="button" class="modalidad-btn" data-modalidad="virtual">Virtual</button>
            <button type="button" class="modalidad-btn" data-modalidad="presencial">Presencial</button>
        </div>
